...
void welcome(){
	...
	cout<<"---------------------------------------------------------------------"<<endl;
	Sleep(50);
	cout<<" 源代码地址:https://github.com/Ender-Dragon-Ballantyne/award-extract"<<endl;
	Sleep(50);
	cout<<"---------------------------------------------------------------------"<<endl;
	Sleep(50);
	...
	cin>>ch;
	if(ch=='o'||ch=='O'){
		system("start https://github.com/Ender-Dragon-Ballantyne/award-extract");
		cout<<"已打开"<<endl;
	}
	else cout<<"不打开"<<endl;
	return; 
...
int main(){
	system("title 奖品抽取-Powered by Ballantyne");
	welcome();
	start();
	for(;;){
		seed++;
